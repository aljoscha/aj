...
mod tests {
    ...
    /// `Markdown::new` takes the theme as a required argument and
    /// applies it directly to render output. We use a sentinel
    /// `code` styler so the marker can't be confused with any of the
    /// test fixture's escape codes.
    #[test]
