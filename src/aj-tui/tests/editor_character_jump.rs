...
// ---------------------------------------------------------------------------
// Jump-mode falls through control characters silently
// ---------------------------------------------------------------------------
...
/// Companion to the silent-fallthrough test. Jump-mode does not
/// consult `tui.select.cancel`, so a user who rebinds it (e.g. to
