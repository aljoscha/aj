...
/// times its `render` method was called. Most tests use it as a
/// fixed-line fixture and ignore the counter; tests that care about
/// child-render frequency (e.g. confirming the box doesn't reach for
/// a child more than once per frame at clamped widths) read it.
